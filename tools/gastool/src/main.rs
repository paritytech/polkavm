...
impl Category {
    ...
    fn from_opcode(opcode: polkavm::program::Opcode) -> Category {
        ...
        match opcode {
            ...
            vector_arithmetic => Compute,
            vector_config => Compute,
            vector_config_dynamic => Compute,
            vector_config_dynamic_discard => Compute,
            vector_count_mask => Compute,
            vector_count_mask_masked => Compute,
            vector_extract => Compute,
            vector_first_mask => Compute,
            vector_first_mask_masked => Compute,
            vector_load => MemoryLoad,
            vector_move => Compute,
            vector_set_equal => Compute,
            vector_set_not_equal => Compute,
            vector_splat => Compute,
            vector_insert => Compute,
            vector_insert_imm => Compute,
            vector_element_index => Compute,
            vector_set_equal_imm => Compute,
            vector_set_not_equal_imm => Compute,
            vector_splat_imm => Compute,
            vector_store => MemoryStore,
            vector_mask_and => Compute,
            vector_mask_and_not => Compute,
            vector_mask_or => Compute,
            vector_mask_xor => Compute,
            vector_mask_nand => Compute,
            vector_mask_nor => Compute,
            vector_mask_or_not => Compute,
            vector_mask_xnor => Compute,
            vector_load_u8 => MemoryLoad,
            vector_store_u8 => MemoryStore,
            vector_load_u16 => MemoryLoad,
            vector_store_u16 => MemoryStore,
            vector_load_u32 => MemoryLoad,
            vector_store_u32 => MemoryStore,
            vector_load_u64 => MemoryLoad,
            vector_store_u64 => MemoryStore,

            wide_add => Compute,
            wide_add_mod => DivMul,
            wide_and => Compute,
            wide_count_leading_zero_bits => Compute,
            wide_count_set_bits => Compute,
            wide_count_trailing_zero_bits => Compute,
            wide_div_signed => DivMul,
            wide_div_unsigned => DivMul,
            wide_exp => DivMul,
            wide_from_reg_signed => Compute,
            wide_from_reg_unsigned => Compute,
            wide_load => MemoryLoad,
            wide_load_absolute => MemoryLoad,
            wide_load_imm_signed => Compute,
            wide_load_imm_unsigned => Compute,
            wide_move => Compute,
            wide_mul => DivMul,
            wide_mul_mod => DivMul,
            wide_or => Compute,
            ...
            wide_reverse_bytes => Compute,
            wide_set_equal => Compute,
            wide_set_less_than_signed => Compute,
            wide_set_less_than_unsigned => Compute,
            wide_set_not_equal => Compute,
            wide_shift_arithmetic_right => Compute,
            wide_shift_arithmetic_right_imm => Compute,
            wide_shift_logical_left => Compute,
            wide_shift_logical_left_imm => Compute,
            wide_shift_logical_right => Compute,
            wide_shift_logical_right_imm => Compute,
            wide_sign_extend_byte => Compute,
            wide_store => MemoryStore,
            wide_sub => Compute,
            wide_to_reg => Compute,
            wide_xor => Compute,

            wide_add_128 => Compute,
            wide_and_128 => Compute,
            wide_count_leading_zero_bits_128 => Compute,
            wide_count_set_bits_128 => Compute,
            wide_count_trailing_zero_bits_128 => Compute,
            wide_div_signed_128 => DivMul,
            wide_div_unsigned_128 => DivMul,
            wide_from_reg_signed_128 => Compute,
            wide_from_reg_unsigned_128 => Compute,
            wide_load_128 => MemoryLoad,
            wide_load_absolute_128 => MemoryLoad,
            wide_load_imm_signed_128 => Compute,
            wide_load_imm_unsigned_128 => Compute,
            wide_move_128 => Compute,
            wide_mul_128 => DivMul,
            wide_or_128 => Compute,
            wide_rem_signed_128 => DivMul,
            wide_rem_unsigned_128 => DivMul,
            wide_reverse_bytes_128 => Compute,
            wide_set_equal_128 => Compute,
            wide_set_less_than_signed_128 => Compute,
            wide_set_less_than_unsigned_128 => Compute,
            wide_set_not_equal_128 => Compute,
            wide_shift_arithmetic_right_128 => Compute,
            wide_shift_arithmetic_right_imm_128 => Compute,
            wide_shift_logical_left_128 => Compute,
            wide_shift_logical_left_imm_128 => Compute,
            wide_shift_logical_right_128 => Compute,
            wide_shift_logical_right_imm_128 => Compute,
            wide_store_128 => MemoryStore,
            wide_sub_128 => Compute,
            wide_to_reg_128 => Compute,
            wide_xor_128 => Compute,
