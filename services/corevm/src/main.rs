...
extern "C" fn accumulate(start_address: u64, length: u64) -> (u64, u64) {
    ...
    if n == 1 {
        ...
        call_log(2, None, &format!("write deleted jam: expect prev len 3, got {:?} (recorded at key 2)", write_result1));
        write_result(write_result1, 2);
        ...
        let delete_result = unsafe { write(dot_address, dot_length, 0, 0) };
        call_log(2, None, &format!("write deleted DOT: expect prev len 3, got {:?} (recorded at key 5)", delete_result));
