...
InstructionSetKind::ReviveV2 => compile_module!(SandboxLinux, B64, build_static_dispatch_table_revive_v2, COMPILER_VISITOR_LINUX, Linux),
...
InstructionSetKind::ReviveV2 => compile_module!(SandboxGeneric, B64, build_static_dispatch_table_revive_v2, COMPILER_VISITOR_GENERIC, Generic),
