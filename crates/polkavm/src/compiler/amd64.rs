    ...
    G: GasVisitorT,
{
    ...
    fn emit_divrem_trampoline_common(&mut self, label: Label, reg_size: RegSize, div_rem: DivRem, kind: Signedness) {
        self.define_label(label);
        self.push(push(rax));
        self.push(push(rdx));
        self.push(push(rbx));
    ...
    pub(crate) fn emit_divrem_trampoline(&mut self) {
        ...
        self.emit_divrem_trampoline_common(self.div32u_label, RegSize::R32, DivRem::Div, Signedness::Unsigned);
        self.emit_divrem_trampoline_common(self.rem32u_label, RegSize::R32, DivRem::Rem, Signedness::Unsigned);

        // Signed 32-bit division.
        self.emit_divrem_trampoline_common(self.div32s_label, RegSize::R32, DivRem::Div, Signedness::Signed);
        self.emit_divrem_trampoline_common(self.rem32s_label, RegSize::R32, DivRem::Rem, Signedness::Signed);

        if B::BITNESS == Bitness::B64 {
            // Unsigned 64-bit division.
            self.emit_divrem_trampoline_common(self.div64u_label, RegSize::R64, DivRem::Div, Signedness::Unsigned);
            self.emit_divrem_trampoline_common(self.rem64u_label, RegSize::R64, DivRem::Rem, Signedness::Unsigned);

            // Signed 64-bit division.
            self.emit_divrem_trampoline_common(self.div64s_label, RegSize::R64, DivRem::Div, Signedness::Signed);
            self.emit_divrem_trampoline_common(self.rem64s_label, RegSize::R64, DivRem::Rem, Signedness::Signed);
        }
    }
